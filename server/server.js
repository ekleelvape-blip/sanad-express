...
app.post('/api/orders', (req, res) => {
  const { branchId, customerName, customerPhone, customerAddress, items, totalAmount, paymentMethod, notes, customerCoords, driverCommission, assignedDriverId, orderNumber } = req.body;
