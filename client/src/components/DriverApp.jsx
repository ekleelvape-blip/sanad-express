...
export default function DriverApp({
  ...
  return (
    <div className="w-full max-w-md mx-auto min-h-screen bg-[#f4f6f8] dark:bg-[#0a0e18] text-slate-800 dark:text-slate-100 flex flex-col font-['Tajawal','IBM_Plex_Sans_Arabic',sans-serif] select-none relative pb-28" dir="rtl">
      ...
      {/* 2. نافذة: المحفظة والعوائد المالية والتسويات (Driver Wallet & Returns) */}
      {showWalletModal && (
        <div className="fixed inset-0 z-[6000] bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 animate-fadeIn" dir="rtl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-sm sm:text-base font-black text-white flex items-center gap-1.5">
                    <span>المحفظة والعوائد المالية</span>
                    <span className="text-[10px] px-2 py-0.5 rounded-full bg-cyan-500/20 text-cyan-300 font-bold font-mono">
                      {currentDriver.name}
                    </span>
                  </h2>
                  <p className="text-[11px] text-slate-400">العوائد القادمة • العوائد المكتملة • سجل التسويات</p>
                </div>
              </div>
              <button
                type="button"
