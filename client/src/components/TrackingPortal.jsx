    ...
    <div className="space-y-6 max-w-4xl mx-auto font-['Cairo',sans-serif]">
      <div className="text-center space-y-2 py-4">
        <div className="flex flex-col items-center mb-3">
          <img src="/sanad-express-logo.jpg?v=3" alt="سَنَد" className="w-20 h-20 rounded-3xl object-cover shadow-[0_0_25px_rgba(0,210,211,0.4)] border-2 border-cyan-500/40 mb-3" />
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-cyan-950/80 border border-cyan-800 text-[#00d2d3] text-xs font-bold">
            <span>منصة سَنَد | تتبع الشحنات المباشر</span>
          </div>
        </div>
      ...
      {data && (
        <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-800 pb-5">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs px-2.5 py-0.5 rounded-full bg-slate-800 text-slate-300 font-bold border border-slate-700">{data.order.hub?.name || 'سَنَد'}</span>
              </div>
          ...
          <div className="py-2">
            <h4 className="text-xs font-bold text-slate-400 mb-4">مراحل الشحن والتوصيل (سَنَد):</h4>
