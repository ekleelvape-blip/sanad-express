    ...
    <div className="space-y-6 font-['Tajawal','IBM_Plex_Sans_Arabic',sans-serif]">
      <div className="bg-[#0f1b23] border border-slate-800 p-6 rounded-3xl shadow-xl flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <img src="/sanad-express-logo.jpg" alt="سَنَد" className="w-14 h-14 rounded-2xl object-cover shadow-lg shadow-emerald-950/60 border border-emerald-500/30 shrink-0" />
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-black text-slate-100">محطة التجهيز والمستودع الذكي - سَنَد</h2>
