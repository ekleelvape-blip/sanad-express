...
import { Settings, Sliders, ShieldCheck, CheckCircle2, Save, Cpu } from 'lucide-react';
      ...
      <div className="bg-[#0f1b23] border border-slate-800 p-6 rounded-3xl shadow-xl flex items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-black text-slate-100 flex items-center gap-2">
            ...
            <span>إعدادات النظام والتوصيل الذكي - سند إكسبريس</span>
          </h2>
          <p className="text-xs text-slate-400 mt-1">
            التحكم في سياسات الإسناد الذاتي، مزامنة الفروع المشتركة، وقواعد الشحن الميداني
          </p>
        </div>
      </div>
