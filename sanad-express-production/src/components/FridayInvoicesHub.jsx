          ...
          <div className="bg-white text-slate-900 rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl relative overflow-hidden font-['Cairo','Tajawal',sans-serif] my-auto">
            ...
            <div id="friday-invoice-print" className="pt-4 space-y-5 text-right">
              ...
              <div className="flex items-center justify-between border-b-2 border-slate-900 pb-4">
                <div className="flex items-center gap-3">
                  <img src="/sanad-express-logo.jpg?v=3" alt="سند إكسبريس" className="w-14 h-14 rounded-2xl object-cover border border-slate-300 shadow-sm" />
                  <div>
                    <h1 className="font-black text-xl text-slate-900">سَنَد إكسبريس اللوجستية</h1>
                    <div className="text-xs text-slate-500 font-mono font-bold tracking-wider">SANAD EXPRESS LOGISTICS</div>
              ...
              {/* منطقة التوقيعات والختم الدائري الرسمي لسند إكسبريس */}
              <div className="pt-3 flex items-center justify-between border-t border-slate-200 relative">
                ...
                {/* الختم الرسمي لسند إكسبريس في المنتصف */}
                <div className="flex flex-col items-center justify-center">
                  <img 
                    src="/sanad-official-stamp.png" 
                    alt="ختم سند إكسبريس الرسمي" 
                    className="w-24 h-24 object-contain mix-blend-multiply drop-shadow-md rotate-[-6deg]" 
                  />
                  <div className="text-[9px] text-slate-400 font-bold mt-1">الختم المالي المعتمد لشركة سند إكسبريس</div>
                </div>
