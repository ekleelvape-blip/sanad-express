...
export default function App() {
      ...
      <div className="min-h-screen bg-[#080c14] text-slate-100 font-['Tajawal','IBM_Plex_Sans_Arabic',sans-serif] selection:bg-cyan-500 selection:text-slate-950 flex flex-col" dir="rtl">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0e18]/95 backdrop-blur-md border-b border-cyan-950/60 px-4 py-3 flex items-center justify-between shadow-xl">
          <div className="flex items-center gap-3">
            <img src="/sanad-express-logo.jpg?v=3" alt="سند إكسبريس" className="w-9 h-9 rounded-xl object-cover border border-cyan-500/40 shadow-[0_0_12px_rgba(0,210,211,0.3)] shrink-0" />
            <div>
              ...
              <div className="text-[9px] text-slate-400 font-mono">SANAD EXPRESS — DRIVER APP</div>
            </div>
          </div>
    ...
    return (
      <div className="min-h-screen bg-[#080c14] text-slate-100 font-['Tajawal',sans-serif]" dir="rtl">
        <header className="p-4 border-b border-cyan-950/60 bg-[#0a0e18] flex items-center justify-between shadow-lg">
          <div className="flex items-center gap-3">
            <img src="/sanad-express-logo.jpg" alt="سند إكسبريس" className="w-10 h-10 rounded-xl object-cover border border-cyan-500/40 shadow-[0_0_12px_rgba(0,210,211,0.3)]" />
            <div>
              <div className="font-black text-white text-base">سَنَد إكسبريس — تتبع الشحنة المباشر</div>
  ...
  return (
    <div className="min-h-screen bg-[#080c14] text-slate-100 flex font-['Tajawal','IBM_Plex_Sans_Arabic',sans-serif] selection:bg-cyan-500 selection:text-slate-950" dir="rtl">
      ...
      {/* القائمة الجانبية المعتمدة لسند إكسبريس */}
      <Sidebar
        activeTab={activeTab}
      ...
      <div className={'flex-1 flex flex-col transition-all duration-300 ' + (sidebarOpen ? 'mr-64' : 'mr-20')}>
        {/* شريط الرأس العلوي (TopBar) المطابق لـ sanadexpress.com */}
