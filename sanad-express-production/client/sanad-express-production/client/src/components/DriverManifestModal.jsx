          ...
          <div id="manifest-print-area" className="w-full bg-white text-black p-8 rounded-none shadow-2xl text-right font-['Cairo',sans-serif]" dir="rtl">
            <div className="flex items-center justify-between border-b-2 border-black pb-4 mb-4">
              <div className="flex items-center gap-3">
                <img src="/sanad-express-logo.jpg?v=3" alt="سند إكسبريس" style={{ width: "45px", height: "45px", borderRadius: "10px", objectFit: "cover" }} />
                <div>
                  <h1 className="text-xl font-black text-black m-0">سَنَد إكسبريس (SANAD EXPRESS)</h1>
            ...
            <div className="mt-6 text-center text-[9px] text-slate-500 border-t border-slate-200 pt-2 font-mono">
              سَنَد إكسبريس (SANAD EXPRESS) • وثيقة رسمية معتمدة • تم الإنشاء إلكترونياً
            </div>
          </div>
        </div>
      </div>
